      ...
      <div class="col-md-4">
        <div class="tier-card text-center tier-classic">
          ...
          <ul class="list-unstyled mb-4">
            ...
            <li class="benefit-item">1 Bonus Stamp Rewards</li>
            <li class="benefit-item">Scratch Cards</li>
          </ul>
          <p class="text-white mb-3"><strong>Price: ₱150/month</strong></p>
      ...
      <div class="col-md-4">
        <div class="tier-card text-center tier-premium">
          ...
          <ul class="list-unstyled mb-4">
            ...
            <li class="benefit-item">Exclusive Offers</li>
            <li class="benefit-item">2 Bonus Stamp Rewards</li>
            <li class="benefit-item">Exclusive Scratch Cards</li>
          </ul>
          <p class="text-white mb-3"><strong>Price: ₱250/month</strong></p>
